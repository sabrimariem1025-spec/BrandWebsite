      ...
      <div className="container-content grid lg:grid-cols-2 gap-16">
        <Reveal>
          ...
          <div className="mt-8 space-y-4 text-sm">
            ...
            <a href={contact.linkedin} className="flex items-center gap-3 hover:text-gold transition-colors">
              <Linkedin size={16} /> LinkedIn
            </a>
            <a href={contact.github} className="flex items-center gap-3 hover:text-gold transition-colors">
